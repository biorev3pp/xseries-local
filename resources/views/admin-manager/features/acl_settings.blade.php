    ...
    <!-- BEGIN: Content-->
     <div class="container-fluid page-wrapper">
      <div class="justify-content-between mb-2">
        <h1 class="a_dash d-inline-block">Floors</h1>
          <div class="row breadcrumbs-top d-inline-block">
            ...
            <div class="btn-group float-md-right">
               <a href="{{url('admin/homes/features/'.base64_encode($floor->id))}}" class="add_button"><i class="la la-arrow-circle-left"></i> Back</a>
            </div>
      </div>
