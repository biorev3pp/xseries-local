...
<div class="container-fluid page-wrapper">
    <div class="row pl-1 pr-1 justify-content-between mb-2 align-items-center">
        <div>
        ...
        <div class="table-responsive">
            <form method="POST" action="{{url('admin/features/save-acl')}}" accept-charset="UTF-8" id="acl_setting_form" novalidate="novalidate">
                    ...
                    <tbody>
                        ...
                        <tr class="tr_clone" id="tr_{{$i}}">
                            ...
                            <td class="w-20 delete_acl_row">
                                <a href="#" id="{{base64_encode($acl['id'])}}" class="delete_record_btn" onclick="deleteData({{$acl['id']}})" data-toggle="modal" data-target="#modal-delete"><i class="fas fa-trash"></i></a>
                            </td>
                ...
                <div class="col-md-3 float-left">
                    <button type="button" data-floor-id="{{$floor->id}}" class="d-none d-sm-inline-block btn  btn-min-width mb-1 waves-effect waves-light clonetrBtn btn-dark"><span class="fa fa-plus">&nbsp;&nbsp;</span>Add Row</button>
                </div>
                <div class="col-md-3 float-right saveACLBtn">
                    <button id="save_acl_btn" type="button" class="float-right d-none d-sm-inline-block btn  btn-min-width mb-1 waves-effect waves-light"><span class="fa fa-save">&nbsp;&nbsp;</span>Save</button>
                </div>
