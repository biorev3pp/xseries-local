...
<div class="container-fluid page-wrapper">
    ...
    <div class="row mb-2 justify-content-between pl-1 pr-1 align-items-center">
            ...
            <div class="row breadcrumbs-top pl-2 d-inline-block">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="{{ route('homes') }}"> {{ $parent_home->title }} </a>
                    </li>
                    <li class="breadcrumb-item">
                        <a href="{{ route('homes_elevation_type',['id'=>base64_encode($home->parent_id)]) }}"> {{ $home->title }} </a>
                    </li>
        ...
        <div class="btn-group">
            <a href="{{ route('homes_elevation_type',['id'=>base64_encode($home->parent_id)]) }}" class="add_button"><i class="fa fa-arrow-left position-relative"></i> Back</a>
        </div>
    </div>
            ...
            <div class="card-body p-0">
                <nav>
                    <div class="nav nav-tabs myTabSettings" role="tablist">
                        <a class="nav-item wf-20 nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true" style="line-height: 30px;">ELEVATION GALLERY</a>
                    </div>
                </nav>
